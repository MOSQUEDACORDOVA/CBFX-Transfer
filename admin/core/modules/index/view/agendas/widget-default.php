                                    ...
                                    <table id="lang_opt" class="table table-striped table-bordered">
					                    ...
					                    ?>
                                         <tr>
                                            ...
                                            <a href="index.php?view=agendaUpdate&id=<?php echo $agenda->id;?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                            <a href="#"  class="btn btn-danger  btnEliminarCliente" idGuia ="<?php echo $agenda->id; ?>" ><i class="fa fa-trash"></i></a>
                                            <a href="index.php?view=galeria&id=<?php echo $agenda->id;?>" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                            </td>
