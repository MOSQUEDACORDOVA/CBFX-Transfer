                        ...
                        <h4 class="card-title">  <a href="#"   class="btn waves-effect waves-light btn-rounded btn-primary"  alt="default" data-toggle="modal" data-target="#responsive-modal"  >Agregar Moneda</a></h4>
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <?php                                     
                                        $monedas = MonedaData::getAll('1');                             
					                        foreach($monedas as $moneda){
					                    ?>
                                         <tr>
                                            <td><?php echo $moneda->pais;?></td>
                                            <td><?php echo $moneda->abreviatura;?></td>                                           
                                            <td style="width:60px;" class ="text-center">       
                                            <a href="index.php?view=moneda&id=<?php echo $moneda->id;?>&moneda=<?php echo $moneda->pais;?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                            <a href="#" class="btn btn-danger btnEliminarMoneda" idMoneda ="<?php echo $moneda->id; ?>"><i class="fa fa-trash"></i></a>
                                        </td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-primary registrarMoneda">Registrar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
